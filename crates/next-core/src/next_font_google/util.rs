...
pub struct FontAxes {
    pub wght: IndexSet<String>,
    pub ital: IndexSet<FontItal>,
    pub variable_axes: Option<Vec<(String, String)>>,
}
...
pub fn get_stylesheet_url(font_family: &str, axes: &FontAxes, display: &str) -> Result<String> {
  ...
  "#,
    ...
    fn test_stylesheet_url_encodes_all_weight_ital_combinations() -> Result<()> {
        assert_eq!(
            ...
            // Note ;-delimited sections for normal@400, italic@500, normal@300, italic@300
